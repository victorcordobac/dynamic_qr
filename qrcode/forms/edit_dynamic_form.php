<fieldset>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <input type="text" name="filename" value="<?php echo htmlspecialchars($edit ? $dynamic_qrcode['filename'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Archivo" class="form-control" required="required" id = "filename">
        </div> 
    </div>
