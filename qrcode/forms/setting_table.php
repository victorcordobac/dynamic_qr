        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <!-- EDIT -->
                    <a href="edit_setting.php?id=<?php echo $row['id']; ?>&operation=edit" class="btn btn-primary"><i class="fas fa-edit"></i></a>
            ...
            <div class="modal fade" id="confirm-delete-<?php echo $row['id']; ?>" role="dialog">
                <div class="modal-dialog">
                    <form action="delete_setting.php" method="POST">
                        <!-- Modal content -->
